...
def main():
    ...
    try:
        ...
        chromadb_instance._initialize_collection(collection_name="Articles")
        ...
        article_publication_date = str(datetime.datetime.now())
        ...
        retrieved_article = chromadb_instance.get_document_query_metadata(query_metadata={"article_id": article_id})
